...
static void log_startup_banner(void) {
  ...
  ESP_LOGI(TAG, "Template ready: update main/user_template.c and "
                "main/include/user_template_config.h for your project");
...
static void log_heartbeat(uint32_t heartbeat_count) {
  ESP_LOGI(TAG, "app=%s heartbeat=%lu uptime_ms=%lu", USER_TEMPLATE_APP_NAME,
